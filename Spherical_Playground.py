...
# Title: Spherical_Antenna_Playground
...
class Spherical_Playground(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Spherical_Antenna_Playground")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Spherical_Antenna_Playground")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Spherical_Playground")
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, 32k,True)
        self.analog_sig_source_x_0 = analog.sig_source_f(10k, analog.GR_COS_WAVE, freq, 1, 0, 0)
...
def main(top_block_cls=Spherical_Playground, options=None):
